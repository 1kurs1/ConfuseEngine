...
namespace ConfuseEngineRenderer {
    ...
    struct PointLight {
        glm::vec4 position{};
        glm::vec4 color{};     // xyz for color and intensity
    };
    ...
    struct GlobalUBO {
        ...
        glm::vec4 ambientLightColor{1.f, 1.f, 1.f, .02f};  // xyz for color and intensity
    ...
    struct FrameInfo {
        ...
        ConfuseEngine::CE_DescriptorPool &frameDescriptorPool;
