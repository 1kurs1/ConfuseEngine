...
namespace ConfuseEngineRenderer {
    ...
    public:
        ...
        CE_SwapChain(CE_Device &deviceRef, VkExtent2D windowExtent);
        CE_SwapChain(CE_Device &deviceRef, VkExtent2D windowExtent, std::shared_ptr<CE_SwapChain> previous);
    ...
    private:
        ...
        std::shared_ptr<CE_SwapChain> m_pOldSwapChain;
