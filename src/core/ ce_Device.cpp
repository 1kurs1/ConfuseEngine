...
CE_Device::CE_Device(ConfuseGraphicsCore::CE_Window &window) : m_window{window} {
  createInstance();
  setupDebugMessenger();
  createSurface();
  pickPhysicalDevice();
...
void CE_Device::createInstance() {
  ...
  appInfo.pApplicationName = "ConfuseEditor";
  appInfo.applicationVersion = VK_MAKE_VERSION(0, 0, 1);
  appInfo.pEngineName = "Confuse Engine";
...
void CE_Device::createSurface() { m_window.createWindowSurface(m_instance, &m_surface); }
...
void CE_Device::populateDebugMessengerCreateInfo(
...
void CE_Device::hasGlfwRequiredInstanceExtensions() {
...
void CE_Device::copyBufferToImage(
...
void CE_Device::createImageWithInfo(
